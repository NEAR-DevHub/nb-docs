...
<Accordion title="Bulk Payment Format">
  ...
  Or download our [template](https://github.com/NEAR-DevHub/trezu-docs/blob/main/assets/files/bulk-payment-template.csv) and fill in the payment details, then upload the file in the **Upload File** section.
</Accordion>
