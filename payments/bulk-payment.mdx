...
Besides being able to create [requests for single payments](./single-payment.mdx), you can also create bulk payment requests to pay multiple recipients at once.
