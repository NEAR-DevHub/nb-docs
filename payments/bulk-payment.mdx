...
<Accordion title="Bulk Payment Format">
  ...
  Or download our [template](https://raw.githubusercontent.com/NEAR-DevHub/trezu-docs/refs/heads/main/assets/files/bulk-payment-template.csv) and fill in the payment details, then upload the file in the **Upload File** section.
</Accordion>
