...
Once a request is created - either to change a [team member's role](./members-and-roles.mdx) or to [change a voting threshold](./voting-settings.mdx) - it is listed as a `Pending` request in the `Requests` section of the left sidebar.
...
## Filtering Governance Requests[​](#filtering-governance-requests "Direct link to Filtering Governance Requests")
