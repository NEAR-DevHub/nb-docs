...
![Pending governance requests](/assets/docs/governance/pending-requests.webp)
...
![Governance request details](/assets/docs/governance/request-details.webp)
...
You can filter governance requests by the following fields: **`Request Type`**, **`Created Date`**, **`Recipient`**, **`Token`**, **`Requester`**, **`Approver`**, and **`My Vote Status`**.

To filter governance requests, click the **`Filter`** icon:

![Governance request filters](/assets/docs/governance/request-filter.webp)

Then add as many filters as needed:

![Filtered governance requests](/assets/docs/governance/filtered-requests.webp)
