...
![Treasury members screen](/assets/docs/governance/members.webp)

<Info>
  You can manage team members and their roles in the **`Members`** section of the left sidebar.
</Info>
...
<Check>
  Members can have multiple roles and receive the combined permissions granted by each assigned role.
</Check>
...
- **✅ Create staking, unstaking, and withdrawal requests**
...
Responsible for configuring the treasury's settings and membership.

<Warning>
  Exercise caution when assigning the Governance role, as it has extensive control over the treasury's settings. [Read more](#governance-is-the-highest-trust-role)
</Warning>
...
- **✅ Create requests to update the treasury's voting threshold**
- **✅ Vote on any treasury configuration requests**
- **✅ Delete their own requests**

#### Cannot

- **❌ Create financial requests (e.g., payments or staking)**
