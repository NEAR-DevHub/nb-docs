...
When creating a treasury, you can set the **`Voting Threshold`** for all requests. This threshold represents the minimum number of approvals required for a proposal to be approved.

![Voting threshold setup](/assets/docs/governance/voting.webp)
...
<Danger>
  Governance proposals can change how decisions are made, significantly affecting the treasury's security and operations. Do not lower the governance threshold unless necessary. [Read more](/governance/members-and-roles#governance-is-the-highest-trust-role)
</Danger>
