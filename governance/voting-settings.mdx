...
When creating a treasury you will be able to setup the `Voting Threshold` for all requests in the treasury, this voting threshold represents the minimum number of approvals required for a proposal to be approved
...
Governance proposals can change how decisions are made, thus having significant impact on the treasury's security and operations. Do not lower the governance threshold unless necessary. [Read More](./members-and-roles.mdx#governance-is-the-highest-trust-role)
