...
Confidential treasuries are multisig wallet smart contracts deployed on a **private shard** on NEAR Protocol. They use technology similar to that securing public treasuries on NEAR while keeping all financial data out of public view.
...
Your treasury can receive public funds through a temporary account and automatically bridge them to the private shard.
