...
<img src="/assets/docs/confidential/ui.png" alt="Confidential treasury interface" />

---

## How Do Confidential Treasuries Work?

Confidential treasuries are multisig wallet smart contracts deployed on a **private shard** on NEAR Protocol. This allows us to use technology similar to that securing public treasuries on NEAR while keeping all financial data out of public view.

<img src="/assets/docs/confidential/diagram.png" alt="Confidential treasury architecture" />
...
Your treasury can receive public funds through a temporary account and automatically bridge them to the private shard. This allows you to fund your treasury from any external wallet just as you would with a public treasury.
...
![Deposit through a temporary address](/assets/docs/confidential/single-use-address.webp)
...
<Tip>
  Read our detailed guide on how to [**fund confidential treasuries through near.com**](/guides/funding-confidential-treasuries).
</Tip>
