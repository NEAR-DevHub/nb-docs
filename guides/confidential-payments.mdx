---
title: "Receiving a Confidential Payment"
...
However, confidential treasuries execute **confidential payments** within a private shard, meaning that the assets are not sent through public blockchains, but instead are credited internally to a [near.com](https://near.com/) account.
