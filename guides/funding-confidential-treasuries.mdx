...
<Tip>
  ...
  Temporary deposit addresses are single-use and remain valid for 72 hours. Create a new one if the address expires before you send the funds.
</Tip>
...
![NEAR Business Receive screen](/assets/docs/confidential/nb-receive.webp)
...
![NEAR Business confidential treasury address](/assets/docs/confidential/nb-private-address.webp)
